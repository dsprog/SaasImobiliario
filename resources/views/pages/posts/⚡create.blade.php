        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div>
                ...
                <input
                    ...
                    autofocus
                    class="mt-1 block w-full text-black rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                @error('title')
            ...
            <div>
                ...
                <textarea
                    ...
                    rows="2"
                    class="mt-1 block text-black w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"></textarea>
                @error('excerpt')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input
                    ...
                    accept="image/*"
                    class="mt-1 block text-black w-full text-sm text-gray-500
